...
<Steps>
  ...
  We assume you are already familiar with using Authelia. Let's say your LobeChat instance is deployed at [https://lobe.example.com/](https://lobe.example.com/).
  ...
  Make sure to replace secret and redirect\_urls with your own values.
