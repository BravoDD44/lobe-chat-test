...
If you need to override NEXT\_PUBLIC environment variables, you can build a custom Docker image using GitHub Actions
...
4. In your GitHub Repository settings > Secrets and variables > Actions > Repository secrets,
   add any NEXT\_PUBLIC variables you want to override
...
This approach allows you to create a custom build with your desired NEXT\_PUBLIC variables without maintaining
